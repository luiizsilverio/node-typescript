...
locationsRouter.get('/', function (req, resp) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, city, uf, items, locations, parsedItems;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.query, city = _a.city, uf = _a.uf, items = _a.items;
                if (!(city && uf && items)) return [3 /*break*/, 2];
                parsedItems = String(items).split(',')
            ...
            case 1:
                locations = _b.sent();
                return [3 /*break*/, 4];
            case 2: return [4 /*yield*/, connection_1.default.select().from('locations')];
            case 3:
                locations = _b.sent();
                _b.label = 4;
            case 4: return [2 /*return*/, resp.json(locations)];
        }
    });
}); });
// Lista os itens da location especificada
locationsRouter.get('/:id', function (req, resp) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                location = _a.sent();
                if (!location) {
                    return [2 /*return*/, resp.status(400).json({ message: "Location not found" })];
                }
            ...
            case 2:
                items = _a.sent();
                return [2 /*return*/, resp.json({ location: location, items: items })];
        }
    });
}); });
// Lista os itens de todas as locations
locationsRouter.get('/items', function (req, resp) { return __awaiter(void 0, void 0, void 0, function () {
    var locations;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, connection_1.default('location_items')
            ...
            case 1:
                locations = _a.sent();
                return [2 /*return*/, resp.json(locations)];
        }
    });
}); });
var schema = celebrate_1.Joi.object().keys({
...
locationsRouter.post('/', celebrate_1.celebrate({ body: schema }, { abortEarly: false }), function (req, resp) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        switch (_b.label) {
            ...
            case 2:
                ...
                locationItems = items.map(function (item_id) {
                    var achouItem = transaction('items').where('id', item_id).first();
                    if (!achouItem) {
            ...
            case 4:
                _b.sent();
                return [2 /*return*/, resp.json(__assign({ id: location_id }, location))];
        }
    });
}); });
...
locationsRouter.put('/:id', upload.single('image'), function (req, resp) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                _b.sent();
                return [2 /*return*/, resp.json(locationUpdated)];
        }
    });
}); });
