...
sessionsRouter.post('/', function (req, resp) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, password, user, passwordOK, token;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                user = _b.sent();
                if (!user) {
                    return [2 /*return*/, resp.status(400).json({ error: "Credentials not found" })];
                }
            ...
            case 2:
                ...
                token = jsonwebtoken_1.sign({}, auth_1.default.jwt.secret, {
                    ...
                    expiresIn: auth_1.default.jwt.expiresIn //'1d'
                });
                delete user.password; // retira a senha do objeto user
                return [2 /*return*/, resp.json({ user: user, token: token })];
        }
    });
}); });
